...
int main() {
    ...
    Message message(uuid_str, puuid_str, suuid_str, "ui12as3", "cout << trhrth", 333, false);
    db.connectToDb("127.0.0.1");
    // std::string out = db.getCodeFromMessage("c033e0ba-aaaf-4ea1-94f7-301954e9d023");
    // db.writeMessage(message);
    std::vector <Message>* messages = db.getNMessagesFromDialogue("25f9e3e6-e1ba-4ae2-b8d8-35b2617e5482", 1);
    if (messages) {
